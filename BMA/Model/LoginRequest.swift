...
struct SignupRequest: Encodable {
    ...
    init(email: String? = nil, name:String? = nil, password:String? = nil, device:String? = nil, categoryRef:String? = nil, fcmToken:String? = nil){
...
struct UpdateUserRequest: Encodable {
    ...
    init(name: String? = nil, location: String? = nil, latitude: Double? = nil, longitude: Double? = nil, activities: [String]? = nil){
